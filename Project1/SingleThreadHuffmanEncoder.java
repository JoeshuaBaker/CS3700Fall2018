...
public class SingleThreadHuffmanEncoder {
	short[] aFreq;
	IntegerBitArray[] codes;
	
	public SingleThreadHuffmanEncoder(String filename) {
		...
		//create array of shorts to be incremented as characters are found
		aFreq = new short[128];
		...
		Driver.specificResults[0][Driver.trialNum] = treeTimer.stop();
		...
		writeData(fr, w, root);
		w.close();
		Driver.specificResults[1][Driver.trialNum] = treeTimer.stop();
