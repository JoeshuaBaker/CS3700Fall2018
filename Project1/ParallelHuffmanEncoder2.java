...
public class ParallelHuffmanEncoder2 {
	AtomicIntegerArray aFreq;
	IntegerBitArray[] codes;
	
	public ParallelHuffmanEncoder2(int threadCount, String filename) {
		...
		Driver.specificResults[4][Driver.trialNum] = treeTimer.stop();
		...
		writeData(fr, w, root);
		w.close();
		Driver.specificResults[5][Driver.trialNum] = treeTimer.stop();
	...
	private class StringReader extends Thread{
		String s;
